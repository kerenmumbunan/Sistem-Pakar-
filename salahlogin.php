...
<div class="container-fluid text-center">    
  <div class="row content">
    <div class="col-sm-2 sidenav">
      ...
      <p><button type="button" class="btn btn-success btn-block" id="myBtn">LOGIN</button></p>
    </div>
    <div class="col-sm-8 text-left"> 
      <center><h2>SPK Penyakit Tanaman DIAGNOSA HAMA DAN PENYAKIT TANAMAN BAWANG MERAH DAN CABAI
</h2></center><br>
        ...
        <div class="modal-body" style="padding:40px 50px;">
          <form role="form" method="post" action="ceklogin.php">
            ...
            <div class="form-group" method="post">
              ...
              <button type="submit" id="submit" nama="submit" class="btn btn-success btn-block" method="post"><span class="glyphicon glyphicon-off"></span> Login</button>
          </form>     
